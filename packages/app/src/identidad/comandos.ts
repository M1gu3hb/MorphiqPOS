 ...
 * dar de alta a un cajero tiene que poder hacerse desde la pantalla — si no,
 * cada cambio de plantilla exige una consola.
 *
 ...
 *
 * Aquí vivía también `generarCodigoDeTerminal`. Se retiró en T2 del port del
 * restaurante junto con el enrolamiento por código: una caja se da de alta sola
 * la primera vez que alguien entra con su PIN desde ese dispositivo.
 */
