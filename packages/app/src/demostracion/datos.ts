...
const RESTAURANTE: SemillaDemo = {
  ...
  insumos: [
    ...
    { clave: 'tortilla', nombre: 'Tortilla de maíz', unidad: 'pieza', costoCentavos: 70n, stock: '600' },
    ...
    { clave: 'frijol', nombre: 'Frijol bayo cocido', unidad: 'g', costoCentavos: 5n, stock: '14000' },
    ...
    { clave: 'chocolate', nombre: 'Chocolate de mesa', unidad: 'g', costoCentavos: 24n, stock: '3000' },
