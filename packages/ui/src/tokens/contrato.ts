 ...
 * derivan los nombres en ingles que pinta la aplicacion, y los demas son
 * variaciones sobre su esqueleto. Los otros dos son de la Fase 1.
 *
 ...
 */
export const ESTILOS_CONSTRUIDOS = ['morphiq', 'premium', 'editorial'] as const;
