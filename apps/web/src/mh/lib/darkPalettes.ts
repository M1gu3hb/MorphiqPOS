/**
 * darkPalettes.ts — Paletas dark-mode para componentes skeuomorphic.
 *
 ...
 *
 * Portado de `historico/restaurante/src/lib/darkPalettes.js`. Cada tabla lleva
 * `prettier-ignore` a propósito: son tablas y se leen como tablas. Partirlas en
 * una propiedad por línea multiplicaría el archivo por cinco y haría imposible
 * comparar un tono claro con su equivalente oscuro de un vistazo, que es
 * exactamente para lo que existe el archivo.
 */

export interface PaletaStatCard {
...
export type ClaveStatCard =
  'primary' | 'green' | 'blue' | 'amber' | 'purple' | 'rose' | 'cyan' | 'slate';

// ============================================================
// Cards de KPI (ColoredStatCard)
// ============================================================
// prettier-ignore
export const STATCARD_PALETTES: Readonly<Record<'light' | 'dark', Readonly<Record<ClaveStatCard, PaletaStatCard>>>> = {
  light: {
...
export interface PaletaMesaOscura {
...
// ============================================================
// prettier-ignore
export const MESA_STATUS_DARK: Readonly<Record<string, PaletaMesaOscura>> = {
...
export interface ColumnaCocina {
  readonly bg: string;
  readonly border: string;
  readonly text: string;
}
...
// ============================================================
// prettier-ignore
export const COCINA_COLS: Readonly<Record<'light' | 'dark', Readonly<Record<string, ColumnaCocina>>>> = {
  light: {
...
// ============================================================
export const STOCK_BADGE_DARK_CLASSES: Readonly<Record<string, string>> = {
...
export const PREP_BADGE_DARK_CLASSES: Readonly<Record<string, string>> = {
...
export const MESA_BADGE_DARK_CLASSES: Readonly<Record<string, string>> = {
...
// ============================================================
export const MARGIN_DARK_BG: Readonly<Record<string, string>> = {
