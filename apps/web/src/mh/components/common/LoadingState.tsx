 ...
 *
 * Portado de `historico/restaurante/src/components/common/LoadingState.jsx`.
 */
interface Props {
...
export default function LoadingState({ label = 'Cargando…', compact = false }: Props) {
  return (
    <div
...
export function RefreshingBadge({ label = 'Actualizando…' }: { readonly label?: string }) {
  return (
