  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Métricas cabecera: grid fijo de 4 columnas iguales para que TODAS las filas
            (variables y fijas) queden perfectamente alineadas entre sí. */}
        <div className="hidden sm:grid grid-cols-4 gap-2 min-w-[440px]">
          {!esVar ? (
            <>
              <div className="text-center px-2">
                <p className="text-[10px] text-muted-foreground uppercase tracking-wide">Precio</p>
                <p className={`font-heading font-bold ${priceColor}`}>
            ...
            <>
              <div className="text-center px-2">
                ...
                <p className={`font-heading font-bold ${priceColor}`}>
                  {formatCurrency(varMetrics.precio)}
                </p>
              </div>
              <div className="text-center px-2">
                <p className="text-[10px] text-muted-foreground uppercase tracking-wide">
              ...
              <div className="text-center px-2 flex items-center justify-center">
                {varMetrics.hay ? (
                  (() => {
                    ...
                    return (
                      <Badge variant="outline" className={`${c.bg} ${c.color} border-0`}>
                ...
                {lines.length > 0 && (
                  <div className="rounded-lg bg-muted/40 border px-3 py-2 flex items-start gap-2">
                    ...
                    <p className="text-[11px] text-muted-foreground">
                      Este producto usa <strong>venta variable</strong>. El escandallo clásico no se
                      usa mientras este tipo de venta esté activo. (No se borraron las líneas
                      anteriores; solo se ignoran visualmente.)
                    </p>
                  </div>
                )}
              </>
          ...
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="space-y-2">
              <span className="block">
                Esto eliminará la receta y retirará el producto del catálogo (POS / Mesero).
              </span>
              <span className="block text-xs">
                No se borran ingredientes del inventario ni ventas históricas.
              </span>
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
