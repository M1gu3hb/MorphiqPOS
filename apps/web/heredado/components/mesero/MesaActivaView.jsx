          ...
          <div className="flex-1 overflow-y-auto p-3 pb-32 md:pb-3 grid grid-cols-2 gap-2 content-start">
            {safeProductos.map((p) => (
              ...
              >
                ...
                <p
                  className={`font-bold text-sm mt-1 ${colorearImportes ? 'text-primary' : 'text-foreground'}`}
                >
                ...
                {safeCarrito.map((item, idx) => (
                  ...
                  >
                    <div className="flex-1 min-w-0">
                      ...
                      <p
                        className={`text-xs font-bold ${colorearImportes ? 'text-primary' : 'text-foreground'}`}
                      >
