...
export default function StockMinCritInput({
  ...
  return (
    <div className="space-y-2">
      {!compact && (
        <p className="text-xs font-medium text-muted-foreground">Alertas de inventario</p>
      )}
          ...
          <p className="text-[11px] text-muted-foreground">
            {Number(valoresEnBase?.stock_minimo) > 0 && (
              <>
                Mín:{' '}
                <strong>
                  {Number(valoresEnBase.stock_minimo).toLocaleString()} {unidadBase}
                </strong>
              </>
            )}
            {Number(valoresEnBase?.stock_minimo) > 0 &&
            ...
            {Number(valoresEnBase?.stock_critico) > 0 && (
              <>
                Crít:{' '}
                <strong>
                  {Number(valoresEnBase.stock_critico).toLocaleString()} {unidadBase}
                </strong>
              </>
            )}
          </p>
