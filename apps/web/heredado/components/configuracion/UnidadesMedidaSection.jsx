...
export default function UnidadesMedidaSection() {
  ...
  const guardar = async () => {
    ...
    try {
      ...
      if (cfg?.id) {
        await api.entidades.ConfiguracionNegocio.update(cfg.id, { unidades_medida_lista: limpio });
      } else {
    ...
    <Card>
      ...
      <CardContent className="space-y-3">
        <p className="text-xs text-muted-foreground">
          ...
          <strong> Registrar inventario existente</strong>. Las unidades base (g, ml, pieza) son
          fijas y se usan para conversiones automáticas.
        </p>
        ...
        <div className="rounded-lg p-3 bg-muted/40 border text-xs flex gap-2">
          ...
          <div className="space-y-1">
            ...
            <p>
              No se repiten por mayúsculas o espacios. Las unidades default siempre están
              disponibles aunque las borres de la lista.
            </p>
          </div>
        </div>
