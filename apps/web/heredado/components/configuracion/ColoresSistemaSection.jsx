  ...
  return (
    <div className="border-t pt-4">
      ...
      <p className="text-xs text-muted-foreground mb-3">
        Personaliza la marca visual del POS. El primario afecta degradados y glow del login; el
        acento afecta botones, sidebar activo y highlights.
      </p>
      ...
      <div className="mt-4">
        ...
        <div style={previewStyle} className="rounded-xl overflow-hidden border bg-[#0a1428]">
          <div className="relative p-4 sm:p-5">
            ...
            <div className="relative grid grid-cols-1 sm:grid-cols-3 gap-3">
              ...
              >
                ...
                <p className="text-[10px]" style={{ color: 'var(--a)' }}>
                  +8% hoy
                </p>
              </div>
            </div>
