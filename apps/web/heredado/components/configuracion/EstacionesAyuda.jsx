    ...
    <div className="rounded-lg border bg-muted/30">
      ...
      {open && (
        <div className="px-3 pb-3 pt-1 text-xs text-muted-foreground space-y-1.5 leading-relaxed">
          <p>
            Las estaciones sirven para separar los pedidos por área de preparación. Por ejemplo: las
            bebidas pueden ir a <strong>Barra</strong>, los postres a <strong>Postres</strong> y los
            alimentos a <strong>Cocina</strong>.
          </p>
          <p>Pasos:</p>
          <ol className="list-decimal pl-4 space-y-0.5">
            ...
            <li>
              Las categorías sin estación van a <strong>Cocina general</strong>.
            </li>
          </ol>
          <p className="pt-1">
            <strong>Importante:</strong> en esta versión la cocina sigue funcionando como hoy. En la
            siguiente actualización cada usuario de cocina podrá ver solo los pedidos de su
            estación.
          </p>
        </div>
      )}
