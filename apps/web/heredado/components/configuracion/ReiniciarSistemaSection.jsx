  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      if (data?.ok) {
        ...
        toast.success(
          'Sistema reiniciado correctamente. Ya puedes configurarlo para un nuevo cliente.',
        );
        setMode(null);
        setConfirmText('');
      ...
      <Card className="border-destructive/40">
        ...
        <CardContent className="space-y-4">
          <div className="rounded-lg border border-destructive/30 bg-destructive/5 p-3">
            <p className="text-sm">
              Esta acción borra todos los datos operativos del POS y deja el sistema limpio para
              configurar un nuevo negocio. <strong>No se puede deshacer.</strong>
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-3">
            ...
            <div className="rounded-lg border border-destructive/30 p-3 flex flex-col gap-2">
              ...
              <p className="text-xs text-muted-foreground">
                Elimina ventas, cortes, compras, gastos, inventario, productos, recetas, mesas,
                solicitudes QR, tickets, movimientos y registros. Resetea la configuración a valores
                base. Conserva tu usuario administrador.
              </p>
              <Button
                variant="destructive"
            ...
            <div className="rounded-lg border border-amber-300/40 p-3 flex flex-col gap-2">
              ...
              <p className="text-xs text-muted-foreground">
                Borra solo ventas, cortes, propinas, pedidos de cocina, solicitudes QR, compras,
                gastos y movimientos. Conserva productos, recetas, ingredientes, mesas, usuarios y
                configuración.
              </p>
              <Button
                variant="outline"
            ...
            <div className="rounded-lg bg-destructive/10 border border-destructive/30 p-3 text-sm">
              {mode === 'all' ? (
                <p>
                  ...
                  <strong>
                    ventas, cortes, compras, gastos, inventario, productos, recetas, mesas,
                    solicitudes QR, tickets, movimientos y registros
                  </strong>
                  . También reseteará la configuración del negocio a valores base.{' '}
                ...
                <p>
                  Esta acción eliminará{' '}
                  <strong>
                    solo ventas, detalles, cortes, propinas, pedidos de cocina, solicitudes QR,
                    compras, gastos y movimientos de inventario
                  </strong>
                  . Se conservarán productos, recetas, ingredientes, mesas, usuarios y
                  configuración.
                  <strong> No se puede deshacer.</strong>
                </p>
              )}
          ...
          <DialogFooter className="gap-2">
            ...
            >
              {loading
                ? 'Reiniciando sistema…'
                : mode === 'all'
                  ? 'Sí, borrar todo y dejar sistema limpio'
                  : 'Sí, borrar ventas y pruebas'}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
