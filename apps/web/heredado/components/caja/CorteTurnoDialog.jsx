...
export default function CorteTurnoDialog({
  ...
  const efectivoEsperado = Number.isFinite(Number(safeResumen.totalEfectivo))
    ? Number(safeResumen.totalEfectivo)
    : 0;
      ...
      <DialogContent className="sm:max-w-lg">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-2 text-sm">
            ...
            <Stat
              label="Transferencia"
              value={formatCurrency(safeResumen.totalTransferencia || 0)}
            />
