      ...
      <div className="rounded-xl border bg-card overflow-hidden">
        <div className="px-4 py-3 border-b bg-muted/30">
          ...
          <p className="text-[10px] text-muted-foreground">
            Ventas y propinas exactas por método (no proporcional).
          </p>
        </div>
            ...
            {metodosConPropinas.length === 0 ? (
              ...
              <>
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="text-right font-mono">
                        {formatCurrency(Number(m?.ventas) || 0)}
                      </span>
                      <span className={`text-right font-mono ${colorTip}`}>
                        {formatCurrency(Number(m?.propinas) || 0)}
                      </span>
                ...
                <div className="grid grid-cols-4 px-4 py-2.5 text-sm items-center bg-muted/20 font-semibold">
                  <span>Total</span>
                  <span className="text-right font-mono">
                    {formatCurrency(totalesMetodos.ventas)}
                  </span>
                  <span className={`text-right font-mono ${colorTip}`}>
                    {formatCurrency(totalesMetodos.propinas)}
                  </span>
                  <span className="text-right font-mono">
                    {formatCurrency(totalesMetodos.total)}
                  </span>
                </div>
              </>
            )}
