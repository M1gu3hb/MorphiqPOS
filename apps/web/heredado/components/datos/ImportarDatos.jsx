...
const TIPOS = [
  {
    ...
    descripcion: 'Carga masiva con anti-duplicados.',
    icon: Boxes,
  },
  {
    key: 'productos',
    titulo: 'Productos',
    descripcion: 'Catálogo con categorías y precios.',
    icon: Tag,
  },
  {
    key: 'recetas',
    titulo: 'Recetas',
    descripcion: 'Requiere ingredientes y productos creados primero.',
    icon: BookOpen,
  },
  {
    key: 'proveedores',
    titulo: 'Proveedores',
    descripcion: 'Directorio de proveedores.',
    icon: Truck,
  },
  {
    key: 'gastos',
    titulo: 'Gastos operativos',
    descripcion: 'Historial de gastos pasados.',
    icon: Receipt,
  },
];
    ...
    <Card>
      <CardHeader>
        ...
        <p className="text-xs text-muted-foreground">
          Sube un CSV (usa la plantilla descargable). El sistema valida primero y muestra vista
          previa. <strong>Nada se guarda hasta que confirmes.</strong>
        </p>
      </CardHeader>
