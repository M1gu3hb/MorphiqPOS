...
const PLANTILLAS = [
  ...
  },
  {
    ...
    descripcion:
      'Una fila por ingrediente. Unidad debe ser compatible con la base (g, kg, ml, l, pieza).',
    columns: [
    ...
    ejemplo: [
      {
        producto_nombre: 'Capuchino',
        ingrediente_nombre: 'Café molido',
        cantidad: 18,
        unidad: 'g',
        merma_porcentaje: 0,
        notas: '',
    ...
    <Card>
      <CardHeader>
        ...
        <p className="text-xs text-muted-foreground">
          Descarga, llena el archivo en Excel o Google Sheets y súbelo en la sección de Importar. El
          archivo trae una fila de ejemplo — bórrala antes de cargar tus datos.
        </p>
      </CardHeader>
