        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              Desde aquí puedes descargar respaldos o cargar datos masivos al sistema. Antes de
              importar, el sistema validará el archivo y te mostrará una vista previa.
