 ...
 */
export default function CocinaStationMiniCard({ pedido, onIniciar, onListo, onQuitarListo }) {
          ...
          <div className="space-y-0.5">
            {items.length === 0 ? (
              ...
              items.map((item, i) => {
                ...
                const modificadoresArr = Array.isArray(item?.modificadores)
                  ? item.modificadores
                  : [];
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p
                        className={`text-xs leading-tight ${tieneExtras ? 'font-bold' : 'font-semibold'}`}
                      >
