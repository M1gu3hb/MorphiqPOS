...
import { TIPO_VENTA, UNIDADES_VARIABLE, mlPorPorcionEfectivo } from '@/utils/tipoVentaUtils';

const TIPO_VENTA_OPCIONES = [
  {
    value: TIPO_VENTA.PRECIO_FIJO,
    label: 'Precio fijo',
    hint: 'Producto clásico con un precio único.',
  },
  {
    value: TIPO_VENTA.VARIABLE_MEDIDA,
    label: 'Variable por medida',
    hint: 'Se vende por peso o volumen (g/kg/ml/l). Ej: barbacoa por gramo.',
  },
  {
    value: TIPO_VENTA.PORCION_CONTENEDOR,
    label: 'Por porción de contenedor',
    hint: 'Se sirven porciones desde un contenedor en ml. Ej: shots de una botella.',
  },
];
      ...
      ...(tipo === TIPO_VENTA.PORCION_CONTENEDOR && ing?.tipo_ingrediente === 'contenedor'
        ? {
            ...
            porciones_por_contenedor:
              v.porciones_por_contenedor ?? ing?.porciones_por_contenedor_default,
        ...
        <div className="space-y-3 pt-2 border-t">
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <Select
                value={v.unidad_variable || 'g'}
                onValueChange={(u) => handle({ unidad_variable: u })}
              >
                <SelectTrigger>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  handle({
                    incremento_variable: e.target.value === '' ? undefined : Number(e.target.value),
                  })
                }
                placeholder="ej. 50"
              />
            ...
            <div className="col-span-2">
              <Label className="text-xs">
                Presets en QR ({v.unidad_variable || 'g'}) — separa con comas
              </Label>
              <Input
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  handle({
                    ml_por_porcion: e.target.value === '' ? undefined : Number(e.target.value),
                  })
                }
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  handle({
                    precio_por_porcion: e.target.value === '' ? undefined : Number(e.target.value),
                  })
                }
                placeholder="0.00"
              />
