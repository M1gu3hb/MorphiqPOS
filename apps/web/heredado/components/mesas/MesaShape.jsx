...
export default function MesaShape({
  mesa,
  onClick,
  draggable = false,
  onDragStart,
  ...
  return (
    ...
    >
      ...
      <span className="font-heading font-bold text-base leading-none">{mesa.numero}</span>
      <span
