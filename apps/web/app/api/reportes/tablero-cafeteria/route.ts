import { tableroDeCafeteria } from '@morphiqpos/app/reportes';

import { manejadorDeComando } from '~/servidor/ruta';

/**
 * F-056 · El tablero de la cafetería: sus catorce indicadores, en una llamada.
 *
 ...
 */
export const POST = manejadorDeComando(tableroDeCafeteria);
