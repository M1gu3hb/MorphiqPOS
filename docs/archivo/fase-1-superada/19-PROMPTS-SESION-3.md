...
**2. La pantalla de configuración afirma algo que no respalda.** Muestra al usuario _"Los permisos de X se vuelven a comprobar en cada comando del servidor"_ y esa pantalla no hace una sola llamada al servidor. Se quita el texto o se cablea la pantalla.
